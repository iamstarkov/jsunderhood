...
RT @denswor: @jsunderhood фраза о важности выбора партнера по парному программированию звучит грозно по соседству с такими твитами http://t.co/fPwnIdfB1D [18][18]
...
RT @deepwalker: @jsunderhood бро, заканчивай эту тоску, пжалста. Или давай сразу про эндофункторы и стрелки и точки неподвижные в разрезе трансдьюсеров. [49][49]
...
Еще немного о ФП [0][0]

Реализация неизменяемых структур данных в JS: Immutable.js http://t.co/V91KzFxqHH и mori http://t.co/NOeLoDUWKS [1][1]

Паттерны ФП https://t.co/yDZWVxEwXO [2][2]

Скринкаст по Haskell https://t.co/YiU0cYxDFr что бы понять, как ФП работает в функциональных языках. [3][3]

И очень крутая лекция про монады https://t.co/6e01jMQ5bE Крокфорд так не объясняет :) [4][4]

Теперь немного о функциональном реактивном программировании... [5][5]

ФРП — это ФП + потоки. [6][6]

Поток — это данные поступающие со временем. [7][7]

На практике это может выглядеть как преобразование событий DOM в поток таких событий и их обработка инструментами ФП. [8][8]

Например как это делает RxJS https://t.co/o6GmtO4MaK [9][9]

Используя базовый набор операций над потоками можно облегчить себе жизнь в создании интерфейсов. [10][10]

Об этом хорошо рассказывает все тот же техлид из Netflix в докладе «Async JavaScript with Reactive Extensions» https://t.co/CctMO3GOB2 [11][11]

Вот еще неплохо написано о реактивном программировании в JS https://t.co/PaFNOockba [12][12]

Короткий и информативный доклад @swannodette о неизменяемых структурах данных https://t.co/Qdx5terHDa /cc @rdvornov [13][13]

На React.js Conf @jlongster рассказал о другом подходе в работе с асинхронным JS пришедшем из Clojure и Go — это CSP https://t.co/nKtzLF2uCF [14][14]

Communicating sequential processes представляет концепцию процессов и каналов, по которым общаются эти процессы. [15][15]

Один процесс забрасывает данные в канал, другой достает их. [16][16]

js-csp https://t.co/SUXRo9Duqb [17][17]

Рядом с CSP всегда упоминаются трансдьюсеры. На Хабре было несколько постов о них. А в этом автор создает их с нуля http://t.co/jtbaABinsz [18][18]

Если просто, то трансдьюсер — это способ трансформирования данных через композицию. [19][19]

А это пятая серия «Better Call Saul» https://t.co/vMBLXXn5ZU [20][20]

## Wednesday

На http://t.co/I4PzXF2Fzy можно почитать об интересных штуках которые не стали частью ES6 и о возможных изменениях в JS в далеком будущем. [0][0]

Например чтсла SIMD (single instruction, multiple data) https://t.co/LVoU8xzPx2 [1][1]

На самом деле SIMD перенесли в ES7 и эта спека уже частично реализованна в FF Nightly. [2][2]

SIMD инструкции обеспечивают параллелизм на уровне данных. [3][3]

Такая оптимизация даст прирост в производительности например в графике, где данные представлены в виде векторов. [4][4]

Например: в JS нету векторов, обычно представляют в виде массива или объекта, тогда операции над такими векторами выполняются почленно... [5][5]

Поэтому [1,2,3] + [1,2,3] выполнится в три процессорных такта, а с SIMD всего в один такт. [6][6]

Спеку можно почитать здесь https://t.co/xAz7zZ5vi6 [7][7]

Наглядный пример оптимизации рендеринга фракталов в asm.js http://t.co/CuKXLQEdPL только FF Nightly [8][8]

Кстати, о графике в вебе. Посмотрите на эти примеры физически правильного рендеринга в WebGL http://t.co/9gQPcioQmE Очень круто! [9][9]

Другая интересная спека — Typed Objects http://t.co/GKuAEblB2J тоже не попала в ES6, но реализована в FF Nightly [10][10]

Типизированные структуры данных `new StructType({ x: uint32, y: uint32 });`. [11][11]

В ночной сборке FF все типы находятся в глобальном объекте TypedObject http://t.co/LyudFyhtfM [12][12]

Или вот предложенный в ES7 оператор `.=` batch assignment для объектов http://t.co/UAsrNX3J8B [13][13]

И guards, как в Haskell http://t.co/iJBeBwD680 [14][14]

Вот еще несколько интересных спек: короткий синтаксис для function expression http://t.co/BqC8plU9f9 [15][15]

Иммутабельные структуры типа объект http://t.co/jQHaYwxbSw [16][16]

И иммутабельные последовательности (массивы, листы) http://t.co/lwfRY2n3JV [17][17]

Параллельно с Atom пробую Light Table http://t.co/mO6K7qUrF5 Особой популярностью не отличается, но есть крутые штуки. [18][18]

Например результат выполнения кода, который пишешь, возникает в той же строке. Наблюдение за значением переменных, тоже круто. [19][19]

Похоже на то, что делает http://t.co/OcRKEGTdRp с тестами. [20][20]

Перед тем, как заняться фронтендом, делал веб-дизайн. Сейчас вкус к красивым интерфейсам практически пропал. Все свелось к минимализму. [21][21]

Вы поддерживаете свои дизайнерские способности? Если да, то каким образом? [22][22]

## Thursday

RT @kinday: @jsunderhood, минимализм не отменяет красоту интерфейса, а наоборот обнажает истинную красоту, скрытую в его логике. [0][0]

RT @vvvlado: @jsunderhood перечитываю «Кради как художник» [1][1]

Джависты недоумевают почему `array === $(array) // false` [2][2]

Это можно объяснить как неявное приведение типов. [3][3]

Еще джавистам сложно понять ООП в JS, что уже говорить о React. Поэтому берут Angular. [4][4]

Fat arrow не единственный новый тип функции в ES6, еще есть tag function: fn `Hello ${name}!`. Вызов без скобок, принимает template string. [5][5]

Используется для чтения исходных данных из строки: значения и части строки http://t.co/mUlFJ9hFop [6][6]

С ES6 Proxy можно делать method missing, как в Ruby http://t.co/2LcUqI4mI6 [7][7]

Но такую штуку можно сделать и без Proxy, через нестандартный метод `__noSuchMethod__`, который вызывается если вызываемого метода нету. [8][8]

А вы стримили в /r/WatchPeopleCode/ ? Или может наблюдали за процессом разработки http://t.co/rsP5bSruFo [9][9]

Можно залипнуть на вечер и узнать что-нибудь новое для себя. Подходы, техники. [10][10]

https://t.co/peumYmg1rK [11][11]

React + CoffeeScript http://t.co/8Th6A4QmpY http://t.co/VZrQrTIoN9 [12][12]

Даже простым +1 в комментариях к обсуждению желаемой фичи вы можете повлиять на ее реализацию. [13][13]

## Friday

Добавил иконку React в плагин file-icons, для подсветки .jsx файлов, в Atom https://t.co/Ik2RFa8vcC http://t.co/ZTPnKibkml [0][0]

Заодно получил опыт создания иконочного шрифта в Inkscape. [1][1]

Суперский инструмент для экспорта набора иконок в шрифт https://t.co/HZjUuuMsDk [2][2]

RT @prbigbrother: @jsunderhood http://t.co/nbBSYMYaO4 с более простым, но схожим функционалом [3][3]

А существует ли логотип закрепленный за картами кода? [4][4]

Видео со вчерашней ng-conf https://t.co/pAAvtfeVzL [5][5]

И итоги EmberConf 2015 https://t.co/P1dEWcjlhJ [6][6]

https://t.co/RNte7I6djx [7][7]

Добротный туториал об npm модулях на ES6 http://t.co/heBIbXlyw2 [8][8]

Библиотека функций высшего порядка для итераторов из ES6 https://t.co/47t0qUJsky [9][9]
